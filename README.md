...
SubManager — кроссплатформенное веб-приложение (PWA + Telegram Mini App) для учета регулярных подписок, финансовой аналитики и напоминаний друзьям через Telegram.
...
- Сплит-оплата: добавление участников и напоминания друзьям.
...
- [x] Inline-кнопки бота («Я перевел(а)»)
- [ ] Telegram Mini App
- [x] Деплой на Vercel
