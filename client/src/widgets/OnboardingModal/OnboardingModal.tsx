...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    text: 'Дели оплату по @username: каждый видит свою долю на вкладке «Друзья», а бот напомнит о переводе.',
  },
  {
    icon: LuCalendarDays,
    color: '#8fe3b0',
  ...
  return (
    <>
      ...
      <div className={`onboarding ${shown ? 'onboarding--open' : ''}`}>
        ...
        >
          <div className="onboarding__illustration" style={{ '--oc': slide.color } as CSSProperties}>
            <Icon size={44} />
          </div>
        ...
        <button className="onboarding__next" onClick={() => (isLast ? finish() : goTo(index + 1))}>
